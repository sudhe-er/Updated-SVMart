							...
							<table class="table">
								<thead>
									<tr>
										...
										<th scope="col" class="border-0 bg-light">
											<div class="py-2 text-uppercase">Price+GST inclusive</div>
										</th>
										<th scope="col" class="border-0 bg-light">
											<div class="py-2 text-uppercase">GST %</div>
										</th>
										<th scope="col" class="border-0 bg-light">
											<div class="py-2 text-uppercase">Original Price (without GST)</div>
										</th>
										<th scope="col" class="border-0 bg-light">
											<div class="py-2 text-uppercase">Shipping Price</div>
										</th>
										<th scope="col" class="border-0 bg-light">
								...
								<tbody>
									...
									<tr id="row_<%= item.getId() %>">
										...
										<td class="border-0 align-middle"><strong
											id="gprice_<%= item.getId() %>"><%= item.getGst() %>%</strong></td>
										<td class="border-0 align-middle"><strong
											id="oprice_<%= item.getId() %>">$<%= item.getOriginalPrice() %></strong></td>
		...
		function getPrice() {
			...
			$('.quantity-input').each(
					function() {
						...
						var origPrice =  parseFloat($('#oprice_' + itemId).text()
								.replace('$', ''));
